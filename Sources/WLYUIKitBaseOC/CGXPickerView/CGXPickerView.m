...
+ (void)showAddressPickerWithTitle:(NSString *)title
    ...
    [CGXAddressPcikerView showAddressPickerWithTitle:title DefaultSelected:defaultSelectedArr dataSource:DataSource IsAutoSelect:isAutoSelect Manager:manager ResultBlock:^(NSArray *selectAddressArr, NSArray *selectAddressRow) {
        if (resultBlock) {
...
+ (NSArray *)showStringPickerDataSourceStyle:(CGXStringPickerViewStyle)style
{
    ...
    if (style == CGXStringPickerViewStyleEducation ||
        ...
        style == CGXStringPickerViewStylBus) {
