...
static NSString * const kPDDictionaryKey = @"com.XABus.dictionaryKey";
static NSString * const kPDKeyChainKey = @"com.XABus.keychainKey";
...
//            CoeSelfLog(@"Unarchive of %@ failed: %@", service, e);
        } @finally {
        }
    }
    if (keyData)
