...
//#define CGXPickerThemeColor [UIColor colorWithRed:39 / 255.0 green:176 / 255.0 blue:236 / 255.0 alpha:1];

#define ThemeColor  [[NSUserDefaults standardUserDefaults] stringForKey:@"themeCorlor"]

#define CGXPickerThemeColor [CGXPickerViewManager colorWithHexString:ThemeColor];
